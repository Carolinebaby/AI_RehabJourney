...
在 patient 的 views.py 文件的 `ai_analyze_health_view` 函数，设置了已经本地部署的大模型名称，目前使用的大模型是 1.5B deepseek，使用 ollama 工具部署在本地，可直接使用 ollama包调用。

![image-20251120153502876](康途同行网站设计文档/image-20251120153502876.png)
...
<img src="康途同行网站设计文档/image-20251120153323092.png" alt="image-20251120153323092" style="zoom:33%;" />
